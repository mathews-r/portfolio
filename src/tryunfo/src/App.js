...
class App extends React.Component {
  ...
  render() {
    ...
    const filterTrunfo = ({ target }) => {
      ...
      if (checked) {
        this.setState((prevState) => ({
          cards: prevState.cards.filter((card) => card.cardTrunfo === true) }));
      } else {
        this.setState({ cards: filtred });
      }
    };
